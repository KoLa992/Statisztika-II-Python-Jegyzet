...
```{python}
[round(0.174 * 9772756, 0), round(0.221 * 9772756, 0)]
```
...
Ugyebár ezt megtehetjük, mert megnéztük a <a href="Gyak03.html" target="_blank">3. heti tananyag 4. fejezetében</a>, hogya medián is egy *torzítatlanul* becsülhető statisutikai paraméter, mint az átlag.
